...
class PackageInfo extends React.Component {
                ...
                <div className="row mb-2">
                  ...
                  <div className="col-sm-6">
                    <ol className="breadcrumb float-sm-right">
                      ...
                      <li className="breadcrumb-item active">Package Info</li>
                    </ol>
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-md-3">
                        ...
                        <ul className="list-group list-group-unbordered mb-3">
                          <li className="list-group-item">
                            ...
                            <a className="float-right">
                              {this.state.parcel.start}
                            </a>
                          </li>
                          <li className="list-group-item">
                            <b>Destination</b>{" "}
                            <a className="float-right">
                              {this.state.parcel.destination}
                            </a>
                          </li>
                          <li className="list-group-item">
                            <b>Location</b>{" "}
                            <a className="float-right">
                              {this.state.parcel.location[0]}, {this.state.parcel.location[1]}
                            </a>
                          </li>
                          <li className="list-group-item">
                            <b>Estimated Delivery Time</b>{" "}
                            <a className="float-right">
                              {this.state.parcel.estTime}
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="card card-primary">
                      ...
                      <div className="card-body">
                        <strong>
                          <i className="far fa-user mr-1" /> Sender ID
                        </strong>
                        <p className="text-muted">{this.state.parcel.senderID}</p>
                        <hr />
                        <strong>
                          <i className="fas fa-user mr-1" /> ReceiverID
                        </strong>
                        <p className="text-muted">{this.state.parcel.receiverID}</p>
                        <hr />
                        <strong>
                          <i className="far fa-clock" /> Time Ordered
                        </strong>
                          {/* <p className="text-muted">
                            {new Intl.DateTimeFormat("en-US", {
                              ...
                              minute: "2-digit",
                              second: "2-digit",
                            }).format(this.state.parcel.timestamp.toDate())}
                          </p> */}
                      </div>
                      {/* /.card-body */}
                    </div>
  ...
  editBranch = async () => {
    const branch = {
      ...
      location: this.state.location.split(","),
