              ...
              <div className="col-md-3">
                ...
                <div className="card card-primary">
                  ...
                  <div className="card-body">
                    <strong>
                      <i className="fas fa-map-marker-alt mr-1" /> Sender ID
                    </strong>
                    <p className="text-muted">{this.state.parcel.senderID}</p>
                    <hr />
                    <strong>
                      <i className="fas fa-truck mr-1" /> ReceiverID
                    </strong>
                    <p className="text-muted">{this.state.parcel.receiverID}</p>
                    <hr />
                    <strong>
                      <i className="far fa-user mr-1" /> Time Ordered
                    </strong>
